                ...
                <>
                    { canRequestFriend(avatarInfo.webID) &&
                        <ContextMenuListItemView onClick={ event => processAction('friend') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/amigos_chiquitos_1.png"
                                alt="Icono"
                                style={ { width: '20px', height: '20px', objectFit: 'contain', marginRight: '5px', position: 'absolute', marginLeft: '-80px' } }
                            />
                            { LocalizeText('infostand.button.friend') }
                        </ContextMenuListItemView> }
                    <ContextMenuListItemView onClick={ event => processAction('trade') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/dinero_1.png"
                            alt="Icono"
                            style={ { width: '20px', height: '20px', objectFit: 'contain', marginRight: '5px', position: 'absolute', marginLeft: '-80px' } }
                        />
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('whisper') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/chatear_1.png"
                            alt="Icono"
                            style={ { width: '20px', height: '20px', objectFit: 'contain', marginRight: '5px', position: 'absolute', marginLeft: '-80px' } }
                        />
                    ...
                    { (userRespectRemaining > 0) &&
                        <ContextMenuListItemView onClick={ event => processAction('respect') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/respetos_1.png"
                                alt="Icono"
                                style={ { width: '20px', height: '20px', objectFit: 'contain', marginRight: '5px', position: 'absolute', marginLeft: '-80px' } }
                            />
                    ...
                    { !avatarInfo.isIgnored &&
                        <ContextMenuListItemView onClick={ event => processAction('ignore') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/mutear_1.png"
                                alt="Icono"
                                style={ { width: '20px', height: '20px', objectFit: 'contain', marginRight: '5px', position: 'absolute', marginLeft: '-80px' } }
                            />
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('report') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/libreta_1.png"
                            alt="Icono"
                            style={ { width: '20px', height: '20px', objectFit: 'contain', marginRight: '5px', position: 'absolute', marginLeft: '-80px' } }
                        />
