...
export const AvatarInfoWidgetOwnAvatarView: FC<AvatarInfoWidgetOwnAvatarViewProps> = props =>
{
    ...
    {
        const iframeWindow = window.open('https://www.ejemplo.com', 'Iframe Window', 'width=400,height=300');
        if (iframeWindow) 
        {
            // Puedes realizar acciones adicionales si es necesario
            // Por ejemplo, agregar un listener para cerrar el iframe cuando se cierre la ventana
        ...
        {
            // Si la ventana no se abrió correctamente, maneja el caso aquí
            console.error('No se pudo abrir la ventana del iframe.');
        }
    };
                ...
                <>
                    ...
                    { isShowDecorate() &&
                        <ContextMenuListItemView onClick={ event => processAction('decorate') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/builders_1.png"
                                alt="Icono"
                                style={ { width: '25px', height: '25px', objectFit: 'contain', marginRight: '5px', position: 'absolute', marginLeft: '-80px' } }
                            />
                            { LocalizeText('widget.avatar.decorate') }
                        </ContextMenuListItemView> }
                    <ContextMenuListItemView onClick={ event => processAction('change_looks') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/ropa_1.png"
                            alt="Icono"
                            style={ { width: '25px', height: '25px', objectFit: 'contain', position: 'absolute', marginLeft: '-80px' } }
                        />
                    ...
                    { (HasHabboClub() && !isRidingHorse) &&
                        <ContextMenuListItemView onClick={ event => processAction('dance_menu') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/bailar_1.png"
                                alt="Icono"
                                style={ { width: '25px', height: '25px', objectFit: 'contain', position: 'absolute', marginLeft: '-80px' } }
                            />
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('expressions') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/expresiones_1.png"
                            alt="Icono"
                            style={ { width: '25px', height: '25px', objectFit: 'contain', position: 'absolute', marginLeft: '-80px' } }
                        />
                        <FaChevronRight className="right fa-icon" />
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('signs') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/amor_1.png"
                            alt="Icono"
                            style={ { width: '25px', height: '25px', objectFit: 'contain', position: 'absolute', marginLeft: '-80px' } }
                        />
                        <FaChevronRight className="right fa-icon" />
            ...
            { (mode === MODE_CLUB_DANCES) &&
                <>
                    { isDancing &&
                        <ContextMenuListItemView onClick={ event => processAction('dance_stop') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/parar_baile_1.png"
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('dance_1') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/dance_1.png"
                            alt="Achievement Score"
                            style={ {
                                width: '35px', 
                                height: '35px',
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('dance_2') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/dance_2.png"
                            alt="Achievement Score"
                            style={ {
                                width: '35px', 
                                height: '35px',
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('dance_3') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/dance_3.png"
                            alt="Achievement Score"
                            style={ {
                                width: '35px', 
                                height: '35px',
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('dance_4') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/dance_4.png"
                            alt="Achievement Score"
                            style={ {
                                width: '35px', 
                                height: '35px',
                ...
                <>
                    { (GetOwnPosture() === AvatarAction.POSTURE_STAND) &&
                        <ContextMenuListItemView onClick={ event => processAction('sit') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/sit_1.png"
                                alt="Achievement Score"
                                style={ {
                                    width: '35px', 
                                    height: '35px',
                    ...
                    { GetCanStandUp() &&
                        <ContextMenuListItemView onClick={ event => processAction('stand') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/stand_1.png"
                                alt="Achievement Score"
                                style={ {
                                    width: '35px', 
                                    height: '35px',
                    ...
                    { GetCanUseExpression() &&
                        <ContextMenuListItemView onClick={ event => processAction('wave') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/wave_1.png"
                                alt="Achievement Score"
                                style={ {
                                    width: '35px', 
                                    height: '35px',
                    ...
                    { GetCanUseExpression() &&
                        <ContextMenuListItemView disabled={ !HasHabboVip() } onClick={ event => processAction('laugh') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/laugh_1.png"
                                alt="Achievement Score"
                                style={ {
                                    width: '35px', 
                                    height: '35px',
                    ...
                    { GetCanUseExpression() &&
                        <ContextMenuListItemView disabled={ !HasHabboVip() } onClick={ event => processAction('blow') }>
                            <img
                                src="https://habbolatam.com/wasseyemma/blow_1.png"
                                alt="Achievement Score"
                                style={ {
                                    width: '35px', 
                                    height: '35px',
                    ...
                    <ContextMenuListItemView onClick={ event => processAction('idle') }>
                        <img
                            src="https://habbolatam.com/wasseyemma/idle_1.png"
                            alt="Achievement Score"
                            style={ {
                                width: '35px', 
                                height: '35px',
