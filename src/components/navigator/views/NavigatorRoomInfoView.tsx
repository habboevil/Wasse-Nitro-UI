                                ...
                                <Flex gap={ 1 }>
                                    <Column grow gap={ 1 }>
                                        <Flex gap={ 1 }>
                                            ...
                                            <Text bold style={ { width: '105px', overflow: 'hidden' } }>{ navigatorData.enteredGuestRoom.roomName }</Text>
                                        </Flex>
                                    ...
                                    <Column alignItems="center" gap={ 1 }>
                                        { hasPermission('settings') &&
                                            <i className="icon icon-cog cursor-pointer" style={ { backgroundColor: '#ededed', boxShadow: '2px 2px rgb(237, 237, 237), inset 0 -3px rgb(237, 237, 237)', border: '#ededed', } } title={ LocalizeText('navigator.room.popup.info.room.settings') } onClick={ event => processAction('open_room_settings') } /> }
