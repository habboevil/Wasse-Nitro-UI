            ...
            <Flex alignItems="center" justifyContent="between" gap={ 2 } className="nitro-toolbar py-1 px-3">
                <Flex gap={ 2 } alignItems="center" className="widthsizemax">
                    <Flex alignItems="center" gap={ 2 }>
                        ...
                        { isInRoom &&
                            <Base pointer className="navigation-item icon icon-habbo" style={ { margin: '3px', height: '45px', } } onClick={ event => VisitDesktop() } /> }
                        { !isInRoom &&
                            <Base pointer className="navigation-item icon icon-house" style={ { margin: '3px', height: '45px', } } onClick={ event => CreateLinkEvent('navigator/goto/home') } /> }
                        <Base pointer className="navigation-item icon icon-rooms" style={ { margin: '3px', height: '45px', } } onClick={ event => CreateLinkEvent('navigator/toggle') } />
                        ...
                        <Base pointer className="navigation-item icon icon-catalog" style={ { margin: '3px', height: '45px', } } onClick={ event => CreateLinkEvent('catalog/toggle') } />
                        <Base pointer className="navigation-item icon icon-inventory" style={ { margin: '3px', height: '45px', } } onClick={ event => CreateLinkEvent('inventory/toggle') }>
                            { (getFullCount > 0) &&
                                <LayoutItemCountView count={ getFullCount } /> }
                        </Base>
                        { isInRoom &&
                            <Base pointer className="navigation-item icon icon-camera" style={ { margin: '3px', height: '45px', } } onClick={ event => CreateLinkEvent('camera/toggle') } /> }
                        { isMod &&
                            <Base pointer className="navigation-item icon icon-modtools" style={ { margin: '3px', height: '45px', } } onClick={ event => CreateLinkEvent('mod-tools/toggle') } /> }
                    </Flex>
