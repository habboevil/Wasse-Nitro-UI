...
export const App: FC<{}> = props =>
{
    ...
    const [ message, setMessage ] = useState('Iniciando carga...');
    ...
    {
        //@ts-ignore
        if(!NitroConfig) throw new Error('NitroConfig no está definido!');
    ...
    const handler = useCallback(async (event: NitroEvent) =>
    {
        switch(event.type)
        {
            ...
            case ConfigurationEvent.FAILED:
                setIsError(true);
                setMessage('La configuración del servidor no es correcta.');
                return;
            case Nitro.WEBGL_UNAVAILABLE:
                setIsError(true);
                setMessage('Usted no tiene WebGL activado.');
                return;
            ...
            case NitroCommunicationDemoEvent.CONNECTION_HANDSHAKE_FAILED:
                setIsError(true);
                setMessage('Se ha producido un error en su SSO.');
                return;
            ...
            case NitroCommunicationDemoEvent.CONNECTION_ERROR:
                setIsError(true);
                setMessage('No se ha podido conectar');
                return;
